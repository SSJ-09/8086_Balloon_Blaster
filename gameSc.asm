...
game_screen:
    ...
    ; Set color 301 (bright blue) = RGB(0, 0, 63)
    mov ax, 0x1010
    mov bx, 301
    mov dh, 0   ; Red
    mov ch, 0   ; Green
    ...
    ; Set color 302 (white) = RGB(63, 63, 63)
    mov ax, 0x1010
    mov bx, 302
    mov dh, 63  ; Red
    mov ch, 63  ; Green
	...
	; set colour 304 (dark blue) = RGB(16,27,40)
	mov ax, 0x1010
    mov bx, 304
    mov dh, 16  ; Red
    mov ch, 27  ; Green
	...
	; set colour 305 (light blue) = RGB(20,35,54)
	mov ax, 0x1010
    mov bx, 307
    mov dh, 20  ; Red
    mov ch, 35  ; Green
